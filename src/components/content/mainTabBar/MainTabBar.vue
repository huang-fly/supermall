<template>
  <tab-bar>
    <tab-bar-item path="/home" isActive="pink">
    ...
    <tab-bar-item path="/category" isActive="pink">
    ...
    <tab-bar-item path="/cart" isActive="pink">
    ...
    <tab-bar-item path="/profile" isActive="pink">
